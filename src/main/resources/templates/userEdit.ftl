    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 text-center">
                <div class="userEditFormWrapper">
                    <div class="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" class="formLogo" x="0px" y="0px" width="80px" height="80px" viewBox="0 0 887.417 887.417" style="enable-background:new 0 0 887.417 887.417; margin: 10px auto;" xml:space="preserve" class=""><g><g>
                                    <g>
                    ...
                    <form action="/user/delete/${user.id?c}" method="post">
                        <input type="hidden" name="_csrf" value="${_csrf.token}" />
                        <div><input type="submit" value="Удалить" style="background-color: #8b1c00; color: #fff; margin: 20px 0;"/></div>
                    </form>
                </div>
            </div>
