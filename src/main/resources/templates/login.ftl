...
<head>
    ...
    <style>
        ...
        input[type=password]:hover, input[type=text]:focus, textarea:focus{
            box-shadow: 0 0 25px rgba(0, 0, 0, 0.5);
            border: 1px solid rgba(0, 0, 0, .9);
            outline: none;
        }
...
<div class="formWrapper">
    <div class="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" class="formLogo" x="0px" y="0px" width="80px" height="80px" viewBox="0 0 887.417 887.417" style="enable-background:new 0 0 887.417 887.417; margin: 10px auto 0 auto;" xml:space="preserve" class=""><g><g>
                    <g>
